...
predict(test_data_path="input/test.csv", model_type="rf", model_path=dispatcher.MODELS)
...
#     submission = predict(test_data_path="input/test.csv", model_type="rf", model_path=dispatcher.MODELS/)
