...
class CrossValidation:
    ...
    def split(self):
        #################
        # Using StratifiedKfold_cross_validation for both binary and multiclass_classification
        ...
        ####################
        # Using Kfold_cross_validation for single_col_regression and multi_col_regression        
